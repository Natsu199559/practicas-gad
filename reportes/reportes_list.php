    ...
    <main class="full-box main-container">
                ...
                <nav class="full-box nav-lateral-menu">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="reportes_list.php"><i class="fas fa-plus fa-fw"></i> &nbsp; Listado
                                        de Reportes</a>
                                </li>
                            </ul>
                        </li>
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fas fa-search fa-fw"></i> &nbsp; Lista Reportes
                </h3>
            </div>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a href="reportes_list.php"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE
                            REPORTES</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="row justify-content-md-center">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label for="inputSearch" class="bmd-label-floating">Ingresa la Placa</label>
                    ...
                    <table class="table table-dark table-sm">
                        ...
                        if (!empty($_POST["btn_buscar_placa"])) {
                            if (!empty($_POST["busqueda-"])) {
                                ...
                                $sql = $conexcion->query("select * from registro where registro_placa='$busqueda'");
                            } else {
                                echo '
                        ...
                        while ($dato = $sql->fetch_object()) {
                            ...
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <?= $dato->registro_nombre ?>
                                    </td>
                                    <td>
                                        <?= $dato->registro_apellido ?>
                                    </td>
                                    <td>
                                        <?= $dato->registro_marca ?>
                                    </td>
                                    <td>
                                        <?= $dato->registro_modelo ?>
                                    </td>
                                    <td>
                                        <?= $dato->registro_placa ?>
                                    </td>
                                    <td>
                                        <a href="../fpdf/plantilla.php?id=<?= $dato->registro_id ?>" class="btn btn-success"
                                            target="_blank">
