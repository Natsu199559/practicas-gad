        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="user-search.php"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR
                            EMPLEADO</a>
                    </li>
                </ul>
            </div>
                        ...
                        <div class="row justify-content-md-center">
                            ...
                            <div class="col-12">
                                <p class="text-center" style="margin-top: 40px;">
                                    <button type="submit" class="btn btn-raised btn-info" name="btn_buscar_user"
                            ...
                            <div class="col-12">
                                <p class="text-center" style="margin-top: 20px;">
                                    <button type="submit" class="btn btn-raised btn-danger"><i class="far fa-trash-alt"
                                            name="bnt-eliminar" value="ok"></i> &nbsp; ELIMINAR BÚSQUEDA</button>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            function borrar(e) {
                ...
                swal({
                        ...
                        buttons: true,
                        dangerMode: true,
                        allowOutsideclic: true,
                        /**pra no salir */
                        allowEscapekey: true,
                        /**para salir por la tecla esc */
                        allowEnterkey: false,
                        /**para salor dando enter */
                    })
                    .then((willDelete) => {
                        if (willDelete) {
            ...
            <div class="container-fluid">
                <div class="table-responsive">
                    <table class="table table-dark table-sm">
                        ...
                        <?php
                        include "../php/usuario/eliminar-usuario.php";
                        $sql = $conexcion->query("select * from usuario");

                        if (!empty($_POST["btn_buscar_user"])) {
                            if (!empty($_POST["busqueda-"])) {
                                $busqueda = $_POST['busqueda-'];
                                $sql = $conexcion->query("select * from usuario where usuario_dni='$busqueda'");
                            } else {
                                echo '
                                    <script type="text/javascript">
                                        swal({
                        ...
                        <tbody>
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="./modificar-user-update.php?id=<?= $dato->usuario_id ?>"
                                ...
                                <td>
                                    <form action="">
                                        <a href="user-search.php?id=<?= $dato->usuario_id ?>" type="button"
                                            class="btn btn-warning" onclick="borrar(event)">
