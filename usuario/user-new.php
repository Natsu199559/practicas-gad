        ...
        <section class="full-box page-content">
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    <li>
                        <a class="active" href="user-new.php"><i class="fas fa-plus fa-fw"></i> &nbsp; NUEVO
                            EMPLEADO</a>
                    </li>
                    <li>
            ...
            include "../php/usuario/agregar_usuario.php";
            ?>
            <div class="container-fluid">
                <form action="" class="form-neon" method="post" autocomplete="off">
                    <fieldset>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9\-]{10,10}" class="form-control"
                                            name="usuario_dni_reg" id="usuario_dni" maxlength="20">
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9()\+]{7,20}" class="form-control"
                                            name="usuario_telefono_reg" id="usuario_telefono" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_direccion" class="bmd-label-floating">Dirección</label>
                                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{5,190}"
                                            class="form-control" name="usuario_direccion_reg" id="usuario_direccion"
                                            maxlength="190">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_usuario" class="bmd-label-floating">Nombre de
                                            usuario</label>
                                        <input type="text" pattern="[a-zA-Z0-9]{4,35}" class="form-control"
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="usuario_clave_1_reg"
                                            id="usuario_clave_1" pattern="[a-zA-Z0-9$@.-]{4,100}" maxlength="100"
                                            required="">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="usuario_clave_2" class="bmd-label-floating">Repetir
                                            contraseña</label>
                                        <input type="password" class="form-control" name="usuario_clave_2_reg"
                                            id="usuario_clave_2" pattern="[a-zA-Z0-9$@.-]{4,100}" maxlength="100"
                                            required="">
                                    </div>
                                </div>
                            </div>
